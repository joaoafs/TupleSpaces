...
import pt.ulisboa.tecnico.tuplespaces.server.ServiceImplA;
...
public class ServerMain {
    ...
    public static void main(String[] args) {
        ...
        final BindableService impl = new ServiceImplA();
        ...
        stub.register(NameServer.RegisterRequest.newBuilder().setServiceName(service).setServerQualifier(qualifier).setServerTarget(address).build());
        ...
        stub.delete(NameServer.DeleteRequest.newBuilder().setServiceName(service).setServerTarget(address).build());
